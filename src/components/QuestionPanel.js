		...
		return (
            ...
            <div style={{ _border: "1px dashed red", width: "100%", padding: "1em", display: 'flex', flexDirection: 'column'}}>
                ...
                <div style={{border: '1px solid green', height: '50%'}}>
                    <div>
                    {_.times(4).map(i => {
                        return (<AnswerItem key={i} selected_answer={selected_answer} answer_from_host={answer_from_host} i={i} option={question_answers[i]} selectAnswer={this.selectAnswer}></AnswerItem>)
                    })}
                    </div>
                </div>
            </div>
